...
const Header = () => {
  ...
  return (
    <header>
      <div className="div-container container-fluid row  justify-content-center">
        <div className="div-date-reseaux col-10 row  justify-content-between ">
          ...
          <div className="div-reseaux col-2">
            <ul className="menu-reseaux navbar-nav mr-auto mt-2 mt-lg-0 justify-content-between">
              <li className="link-reseaux col-4 nav-item">
